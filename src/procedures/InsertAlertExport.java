...
public class InsertAlertExport extends VoltProcedure {
    ...
    public final SQLStmt insertAlertExport =
        new SQLStmt("INSERT INTO alerts_export VALUES (?, ?);");
    ...
    public long run(int sensor_id, TimestampType record_date, TimestampType record_time,
        ...
        if (results[1].asScalarLong() >= 200000 && results[2].getRowCount() == 0) {
            ...
            voltQueueSQL(insertAlertExport, sensor_id, record_date);
            voltExecuteSQL(true);
            return 1;
        }
